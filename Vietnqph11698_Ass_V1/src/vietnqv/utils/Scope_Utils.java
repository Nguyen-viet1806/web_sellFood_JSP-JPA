...
public class Scope_Utils {
	public static HttpServletRequest request() {
		return RRShare_Utils.request();
	}

	public static HttpSession session() {
		return RRShare_Utils.request().getSession();
	}

	public static ServletContext application() {
		return RRShare_Utils.request().getServletContext();
	}
	...
	@SuppressWarnings("unchecked")
	public static <T> T getAttlication(String name) {
